<?php
session_start();
$nameErr = $emailErr = $genderErr = $addressErr = $pincodeErr = $contactErr = $usernameErr = $passwordErr = "";
$name = $email = $gender = $address = $pincode = $contact = $uname = $upassword = "";
$cID;
...
$sql = "SELECT users.UserName, users.Password, customer.CustomerName, customer.PinCode, customer.CustomerEmail, customer.CustomerPhone, customer.CustomerGender, customer.CustomerAddress
	FROM users, customer
										...
										if(!preg_match("/^[0-9 -]*$/", $contact)){
											...
											if (empty($_POST["gender"])){
												...
												if (empty($_POST["address"])){
													...
													PinCode = '".$pincode."', CustomerEmail = '".$email."', CustomerAddress = '".$address."', 
...
<header>
<blockquote>
	<a href="index.php"><img src="images/logonew.jpg" height="70px"></a>
</blockquote>
</header>
<blockquote>
<div class="container">
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	PIN Code:<br><input type="text" name="pincode" placeholder="<?php echo $oPinCode; ?>">
	<span class="error" style="color: red; font-size: 0.8em;"><?php echo $pincodeErr;?></span><br><br>
