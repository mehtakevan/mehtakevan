										...
										if(!preg_match("/^[0-9 -]*$/", $contact)){
											...
											if (empty($_POST["gender"])){
												...
												if (empty($_POST["address"])){
													...
													$sql = "INSERT INTO customer(CustomerName, CustomerPhone, PinCode, CustomerEmail, CustomerAddress, CustomerGender, UserID) 
													VALUES('".$name."', '".$contact."', '".$pincode."', '".$email."', '".$address."', '".$gender."', ".$id.")";
													$conn->query($sql);
...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	PIN Code:<br><input type="text" name="pincode" placeholder="xxxxxx">
